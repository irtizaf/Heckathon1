...
const Page = () => {
    ...
    return (
        <div className="grid justify-center gap-10 ">
            <div>
                <div>
                    <h1 className='text-blue-700 font-bold text-sm text-center mt-10'>PRODUCTS</h1>
                ...
                <div className='grid mobile:grid-cols-1 small:grid-cols-2  tablet:grid-cols-4 gap-20 max-w-[1200px] mx-auto mt-10 '>
                    {
                        products.map((product: any, id: any) => {
                            return <div className='mt-5 mobile:mx-5 tablet:ml-0' key={id}>
                                ...
                                <h1 className="card-title  text-lg font-bold mt-1">{product.title}</h1>
                                <h2 className='font-semibold text-lg py-2'>{product.sub_category}</h2>
